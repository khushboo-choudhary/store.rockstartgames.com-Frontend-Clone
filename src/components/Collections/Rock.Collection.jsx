...
const Rock = () => {
  ...
  useEffect(() => {
    axios.get(`https://clear-pear-tuna.cyclic.app/games/rock`).then((res) => {
      setGamesrock(res.data.games);
    });
    axios
      .get(`https://clear-pear-tuna.cyclic.app/coll/rock/apparel`)
      .then((res) => {
        setApparelrock(res.data.collection);
      });
    axios
      .get(`https://clear-pear-tuna.cyclic.app/coll/rock/gear`)
      .then((res) => {
