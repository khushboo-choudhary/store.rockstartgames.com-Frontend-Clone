...
const SharkCards = () => {
    return (
        <div id="mainCards">
            <div>
                <div><img src="https://images.ctfassets.net/wn7ipiv9ue5v/7aCrEY5Etpgk5a9V6JQaYm/088f756121545886ab0bb3f54339c3ea/GTAV_SharkCard_Group_01.jpg?w=1920&h=&fm=webp&q=" alt="" className="src" /></div>
                <h1>Shark Cards</h1>
